...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-13 21:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c9ebaf5a-318c-4fa1-9b7d-4027f4567140.git
$ cd c9ebaf5a-318c-4fa1-9b7d-4027f4567140
```
